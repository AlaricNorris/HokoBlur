 ...
 */
public class RsBlurFrameLayout extends FrameLayout {
    ...
    public RsBlurFrameLayout(Context context) {
        super(context);
        init();
    }

    public RsBlurFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RsBlurFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
