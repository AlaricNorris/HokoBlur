 ...
 */
public class RsBlurRelativeLayout extends RelativeLayout {
    ...
    public RsBlurRelativeLayout(Context context) {
        super(context);
        init();
    }

    public RsBlurRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RsBlurRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
